...
export default function LotsPage() {
  const newListings = getNewListings("Lot");
  const listings = getListingsByType("Lot");
  const nextMonth = getAvailableNextMonth("Lot");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <ListingSection title="Relevant lots in Cebu City" listings={listings} sectionIndex={1} />
